...
public class QueryTarticleListServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			// 获取当前的页数
			List<TarticleBean> tars = us.queryByPage(page, size);
			// 获取总页数
			...
			// 将用户集合存储到req作用域
			req.setAttribute("tars", tars);
			// 转发到用户查询页面，在查询页面显示数据
			req.getRequestDispatcher("Tarticle/list.jsp").forward(req, resp);
