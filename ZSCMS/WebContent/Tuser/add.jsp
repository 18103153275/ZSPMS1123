...
<script type="text/javascript">
	...
	function chkpassword() {
		...
		if (reg.test(password)) {
			...
			$("#resultPwd").html("密码必须包含数字与字母且不能低于六位");
				...
				<tbody>
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="loginname" id="loginname"  onblur="chkloginname()" maxlength="100" />
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="password"
							class="required" name="password" id="password" onblur="chkpassword()"  maxlength="100" />
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="password"
							class="required" name="repwd" id="repwd" onblur="chkRePwd()"  maxlength="100" /> <span
							style="color: red">${pwdMsg }</span>
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="realname" id="realname" onblur="chkrealname()"  maxlength="100" />
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="Wdate" name="birthday" id="birthday" onblur="chkbirthday()" maxlength="80" 
							onclick="WdatePicker()" />
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="email" id="email" onblur="chkemail()" maxlength="80" />
